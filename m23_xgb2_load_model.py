...
# )
# model.save_model('./_save/ModelCheckPoint/xgb_m21_model.dat')
# dnn verbose처럼 학습되는 걸 보여줌
model = XGBRegressor()
model.load_model('./_save/ModelCheckPoint/xgb_m21_model.dat')
# 4. 평가
...
# 저장
'''
# pickle.dump(model, open('./_save/xgb_save/xgb_m21_pickle.dat', 'wb'))
model = joblib.load('./_save/xgb_save/xgb_m22_joblib.dat')
results = model.score(x_test, y_test)
print("results : ", results)
